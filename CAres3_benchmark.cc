...
int main(){
    ...
    EEC::CARes3Calculator calculator(
        bins,
        bins, bins,
        EEC::normType::RAWPT
    );

    printf("Benchmarking CARes3Calculator...\n\n");
    printf("NPART = %d\n", NPART);
    printf("NITER = %d\n", NITER);
    printf("NBINS = %d\n", NBINS);
    printf("\n");
    ...
    printf("PLAIN\n");
    unsigned long t1 = benchmarkCalculator<EEC::Res3Result_Vector, EEC::CARes3Calculator, false>(
            calculator, jetFactory);
    printf("\tJIT vector: %lu ms\n", t1);

    unsigned long t2 = benchmarkCalculator<EEC::Res3Result_MultiArray, EEC::CARes3Calculator, false>(
            calculator, jetFactory);
    printf("\tJIT multiarray: %lu ms\n", t2);

    unsigned long t3 = benchmarkCalculator<EEC::Res3Result_Vector, EEC::CARes3Calculator, true>(
            calculator, jetFactory);
    printf("\tprecomputed vector: %lu ms\n", t3);

    unsigned long t4 = benchmarkCalculator<EEC::Res3Result_MultiArray, EEC::CARes3Calculator, true>(
            calculator, jetFactory);
    printf("\tprecomputed multiarray: %lu ms\n", t4);

    printf("WITH UNMATCHED\n");
    unsigned long t5 = benchmarkCalculator_unmatched<EEC::Res3Result_Vector, EEC::CARes3Calculator, false>(
            calculator, jetFactory);
    printf("\tJIT vector: %lu ms\n", t5);

    unsigned long t6 = benchmarkCalculator_unmatched<EEC::Res3Result_MultiArray, EEC::CARes3Calculator, false>(
            calculator, jetFactory);
    printf("\tJIT multiarray: %lu ms\n", t6);

    unsigned long t7 = benchmarkCalculator_unmatched<EEC::Res3Result_Vector, EEC::CARes3Calculator, true>(
            calculator, jetFactory);
    printf("\tprecomputed vector: %lu ms\n", t7);

    unsigned long t8 = benchmarkCalculator_unmatched<EEC::Res3Result_MultiArray, EEC::CARes3Calculator, true>(
            calculator, jetFactory);
    printf("\tprecomputed multiarray: %lu ms\n", t8);

    EEC::CARes3TransferCalculator tcalculator(
        bins, bins, bins,
        bins, bins, bins,
        EEC::normType::RAWPT
    );
