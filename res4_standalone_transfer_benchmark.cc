...
int main(){
    ...
    for (int i=0; i<NITER; ++i){
        ...
        standaloneEEC::res4_transfer_result_vector transfer_result(
            NBINS, NBINS, NBINS, NBINS, NBINS, NBINS, NBINS,
            NBINS, NBINS, NBINS, NBINS, NBINS, NBINS, NBINS
        );

        standaloneEEC::res4_standalone_transfer_vector(
                result,
                transfer_result,
                J1, J2,
                standaloneEEC::normType::RAWPT,
    ...
    deltat = std::chrono::duration_cast<std::chrono::milliseconds>(t1-t0).count();
    printf("standalone vector: %lu ms\n", deltat);
    ...
    for (int i=0; i<NITER; ++i){
        ...
        runFastEEC(
                ...
                4,
                fastEEC::DORES4 | fastEEC::DOTRANSFER,
